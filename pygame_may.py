...
# Images
wheat_img = pygame.image.load("may_images/wheat_field.png").convert()
may_img = pygame.image.load("may_images/may.png").convert()
may_img.set_colorkey(white)
corbyn_img = pygame.image.load("may_images/corbyn_big.png").convert()
corbyn_img.set_colorkey(white)
boris_img = pygame.image.load("may_images/boris.png").convert()
boris_img.set_colorkey(white)
gove_img = pygame.image.load("may_images/gove.png").convert()
gove_img.set_colorkey(white)
sturgeon_img = pygame.image.load("may_images/sturgeon_big.png").convert()
sturgeon_img.set_colorkey(white)
rudd_img = pygame.image.load("may_images/rudd.png").convert()
rudd_img.set_colorkey(white)
bus_img = pygame.image.load("may_images/debate_bus.png").convert()
bus_img.set_colorkey(white)
nurse_img = pygame.image.load("may_images/nurse.png").convert()
nurse_img.set_colorkey(backcol)
police_img = pygame.image.load("may_images/police.png").convert()
police_img.set_colorkey(white)
boris_zip_img = pygame.image.load("may_images/boris_zip_big.png").convert()
boris_zip_img.set_colorkey(white)
scissors_img = pygame.image.load("may_images/scissors.png").convert()
scissors_img.set_colorkey(white)
brexit_img = pygame.image.load("may_images/brexit.png").convert()
dup_img = pygame.image.load("may_images/DUP.png").convert()
farage_img = pygame.image.load("may_images/farage.png").convert()
farage_img.set_colorkey(white)
yes_img = pygame.image.load("may_images/indyref_yes.png").convert()
yes_img.set_colorkey(white)
fireball_img = pygame.image.load("may_images/fireball_2.png").convert()
fireball_img.set_colorkey(black)
backbenchers_img = pygame.image.load("may_images/backbenchers.png").convert()
backbenchers_img.set_colorkey(white)
union_flag_img = pygame.image.load("may_images/union_flag.png").convert()
bonus_img = pygame.image.load("may_images/plus_50.png").convert()
bonus_img.set_colorkey(black)
bush_img = pygame.image.load("may_images/bushy_background.png").convert()
fox1_img = pygame.image.load("may_images/fox_1.png").convert()
fox1_img.set_colorkey(green3)
fox2_img = pygame.image.load("may_images/fox_2.png").convert()
fox2_img.set_colorkey(green3)
fox3_img = pygame.image.load("may_images/fox_3.png").convert()
fox3_img.set_colorkey(green3)
fox4_img = pygame.image.load("may_images/fox_4.png").convert()
fox4_img.set_colorkey(green3)
crosshairs_img = pygame.image.load("may_images/crosshairs.png").convert()
crosshairs_img.set_colorkey(white)
blood_img = pygame.image.load("may_images/blood.png").convert()
blood_img.set_colorkey(black)
shotgun_img = pygame.image.load("may_images/shotgun_barrel.png").convert()
shotgun_img.set_colorkey(white)
cameron_img = pygame.image.load("may_images/hanging_cameron.png").convert()
cameron_img.set_colorkey(white)
queenT_img = pygame.image.load("may_images/queen_theresa.png").convert()
queenT_img.set_colorkey(black)
crown_img = pygame.image.load("may_images/crown.png").convert()
crown_img.set_colorkey(black)
brexit2_img = pygame.image.load("may_images/brexit2.png").convert()

# Sounds
shot_sound = pygame.mixer.Sound("may_sounds/shotgun.wav")
